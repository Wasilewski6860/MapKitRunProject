...
class GetAllRunsSortedByTimeInMillisUseCase(private val runsRepository: RunsRepository) {

    suspend fun execute() = runsRepository.getAllRunsSortedByTimeInMillis()
}